...
class SoftUiGeneralPanelCard extends LitElement {
                ...
                return stateObj ? html`
                    <div class="frame_1">
                              ...
                              ${ent.cardtype == "sensor" ? html`
                                    <div class="${iconemboss? 'icon_noclick icon_shadow' : 'icon_noclick'}">
...
customElements.define('soft-ui-general_panel_card', SoftUiGeneralPanelCard);
